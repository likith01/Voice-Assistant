...
import { CoreMediaService } from "@base/services/media.service";
...
@Component({
  ...
  styleUrl: './core-sidebar.component.scss',
...
export class CoreSidebarComponent implements OnInit, OnDestroy {
  ...
  iscollapsibleSidebar: boolean | undefined;
  ...
  constructor(
    ...
    private _coreConfigService: BaseConfigService,
  ...
  private _showOverlay(): void {
    ...
    if (!this.overlayVisibility && this._overlay ) {
